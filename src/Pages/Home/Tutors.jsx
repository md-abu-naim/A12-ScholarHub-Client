        ...
        <div className="max-w-md p-4 text-white">
            <div className="card rounded-none">
                <div className=" dropdown relative dropdown-hover rounded-md">
                    <div tabIndex={0} role="button" className="flex items-center justify-center" ><img className=' w-[350px] border-[#C59D5F] border h-[300px] rounded-sm' src={image} alt="Shoes" /></div>
